...
function ChartSkeleton() {
  return (
    <div className="rounded-lg border border-border bg-surface p-5">
      <div className="h-4 w-32 animate-shimmer rounded bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 bg-[length:200%_100%] mb-4" />
      <div className="h-48 animate-shimmer rounded bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 bg-[length:200%_100%]" />
    </div>
  );
}
...
function ProgressTracker() {
  ...
  return (
    <div className="mt-8 pt-8 border-t border-border space-y-6">
      ...
      {/* Confidence history chart (lazy-loaded) */}
      <ConfidenceChart data={data.confidence_history} />
