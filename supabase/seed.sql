-- ============================================================
-- Waypointer Prompt Registry Seed Data
-- ============================================================
-- This file inserts all 15 prompts from the Waypointer Prompt Registry
-- into the prompt_registry table. It is idempotent — re-running it
-- will not create duplicates thanks to ON CONFLICT DO NOTHING.
--
-- Source: waypointer_prompt_registry.md v1.0 (March 15, 2026)
-- ============================================================

-- Prompt 1: EXTRACT_STRUCTURAL
INSERT INTO prompt_registry (prompt_id, version, system_prompt, user_prompt_template, model, max_tokens, temperature, is_active)
VALUES (
  'EXTRACT_STRUCTURAL',
  1,
...
-- Note: This prompt is sent to ElevenLabs Conversational AI, not Claude.
-- It is stored in the registry so it can be iterated on without code changes.
-- The user_prompt_template is N/A for this prompt (the system_prompt contains the variables).
INSERT INTO prompt_registry (prompt_id, version, system_prompt, user_prompt_template, model, max_tokens, temperature, is_active)
VALUES (
  'INTERVIEW_PERSONA',
  1,
...
- Be professional, neutral, and realistic. Not overly friendly, not intimidating.',
  'N/A — This prompt is used as the ElevenLabs Conversational AI agent system prompt. Variables are injected into the system_prompt before creating the ElevenLabs conversation session.',
